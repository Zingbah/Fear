...
FearShaman.career_module = {
	...
	max_level = 11,
	abilities = {
		[1910]  = {id = 1910,  name = "Mork's Buffer", 					rank = 7, rating = 20},
		[1932]  = {id = 1932,  name = "Don' Feel Nuthin", 				rank = 5, rating = 5, isShield=true, maxHealth = 35, minHealth = 0},
		
		[1904]  = {id = 1904,  name = "Bigger, Better, An' Greener",	rank = 8, rating = 10, maxHealth = 75, minHealth = 20,},
		[1901]  = {id = 1901,  name = "Ey, Quit Bleedin", 				rank = 3, rating = 13, maxHealth = 85, minHealth = 0,},
		[1898]  = {id = 1898,  name = "Gork'll Fix It", 				rank = 1, rating = 15, maxHealth = 95, minHealth = 0,},
		[1908]  = {id = 1908,  name = "Gedup!", 						rank = 10, rating = 8,},
		
		[1912]  = {id = 1912,  name = "Bleed Fer' Me", 					rank = 8, rating = 17, maxHealth = 95, minHealth = 0,},
